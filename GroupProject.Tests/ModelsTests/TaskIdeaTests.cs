...
namespace ProjectManagementApp.Tests
{
    public class TaskIdeaTests
    {
        ...
        {
            // Arrange
            var taskIdea = new TaskIdea(1, "title", "description", TaskPriority.Medium, "assignedTo", 101);
        ...
        {
            // Arrange
            var taskIdea = new TaskIdea(1, "title", "description", TaskPriority.Medium, "assignedTo", 1);
