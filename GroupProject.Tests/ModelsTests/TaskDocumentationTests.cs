...
namespace ProjectManagementApp.Tests
{
    public class TaskDocumentationTests
    {
        ...
        {
            // Arrange
            var taskDocumentation = new TaskDocumentation(1, "title", "description", "assignedTo", 101);
        ...
        {
            // Arrange
            var taskDocumentation = new TaskDocumentation(1, "title", "description", "assignedTo", 1);
