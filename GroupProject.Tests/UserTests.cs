...
public class UserTests
{
    ...
    public void Constructor_ShouldInitializeUsername()
    {
        ...
        var user = new MockUser(username, "password123");
    ...
    {
        var user = new MockUser("testuser", "password123");
    ...
    {
        public MockUser(string username, string password) : base(username, password) { }
    }
}